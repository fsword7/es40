 ...
 * Constructor.
 **/
CCirrus::CCirrus (CConfigurator * cfg, CSystem * c, int pcibus,
...
void
  CCirrus::WriteMem_Bar (int func, int bar, u32 address, int dsize, u32 data)
{
  switch (bar)
  {
  case 0:                      /* pci memory */
...
void
  CCirrus::redraw_area (unsigned x0, unsigned y0, unsigned width,
                        unsigned height)
{
...
void
  CCirrus::determine_screen_dimensions (unsigned *piHeight, unsigned *piWidth)
{
  int ai[0x20];
  int i, h, v;
  for (i = 0; i < 0x20; i++)
