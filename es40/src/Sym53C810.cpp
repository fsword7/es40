...
#define PTD get_disk(0, GET_DEST())
  ...
  u32 osym_cfg_data[64] =
  {
    ...
    /*00*/
    0x00011000,       // CFID: vendor + device

  /*04*/
  0x02000001,         // CFCS: command + status

  /*08*/
  0x01000001,         // CFRV: class + revision
 ...
 * Constructor.
 **/
CSym53C810::CSym53C810(CConfigurator* cfg, CSystem* c, int pcibus, int pcidev) : CDiskController(cfg, c, pcibus, pcidev, 1, 7), mySemaphore(0, 1)
{
