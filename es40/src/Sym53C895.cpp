...
CSym53C895::CSym53C895 (CConfigurator * cfg, CSystem * c, int pcibus,
...
void
  CSym53C895::WriteMem_Bar (int func, int bar, u32 address, int dsize,
                            u32 data)
{
  void *p;
...
u32
  CSym53C895::config_read_custom (int func, u32 address, int dsize, u32 data)
{
  if (address >= 0x80)
...
void
  CSym53C895::config_write_custom (int func, u32 address, int dsize,
